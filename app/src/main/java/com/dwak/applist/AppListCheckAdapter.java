...
public class AppListCheckAdapter extends ArrayAdapter{
    private final List<AppListItem> mItems;
    private final Context mContext;

    public AppListCheckAdapter(Context context, int resource, List<AppListItem> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.list_item_checkbox, parent, false);
